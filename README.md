<p align="center">
  <img src="https://capsule-render.vercel.app/api?text=Tech Solutions&animation=fadeIn&type=waving&color=gradient&height=100"/>
</p>
...
## Skills
- :seedling: Frontend : React, Next, Web3.js, Angular, Vue, Nuxt, Jquery, Material UI, Bootstrap, TailwindCSS
- :telescope: Backend : NodeJs, CI, Laravel, Django, Express, Nestjs, PHP,
- :calling: Mobile: Android, React Native, Ionic, Flutter
- :jigsaw: Database : MySQL, PostgreSQL, MongoDB, Firestore, MariaDB, SQLite, AES Lambda, Spring Cloud
- :speech_balloon: Language : HTML, CSS, Javascript, Typescript, Python, PHP, C++, C#, Go
- :fire: CMS: WordPress, Shopify, Wix, Framer, Webflow
